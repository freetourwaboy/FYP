function Code39binary(code) {
    switch (code) {
      ...
      case '%':
        return '101001001001';
      case '*':
        return '100101101101';//idk this 100101101101 or 1001011011011
    }
  }
  

function generateCode39(code) {
      checkerrorCode39(code);
      let barcode = '1001011011011 ';
      for (let i=0;i<code.length;i++)
      {
        barcode+=Code39binary(code[i]);
        barcode+=" ";
      }
      barcode+="1001011011011";
      return barcode;
}
function checkerrorCode39(code){
  ...
  //it is recommended to limit the number of characters in a Code 39 barcode to 20-25 characters or less.
  if (code.length > 20) {
